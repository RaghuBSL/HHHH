...
public class TraineeController implements Serializable {
    ...
    private String traineeEditForm = "/Trainee/TraineeEdit.xhtml";
    ...
    /**
     * @return the traineeEditForm
     */
    public String getTraineeEditForm() {
        System.out.println( "fetching edit form ");
        return traineeEditForm;
    }

    /**
     * @param traineeEditForm the traineeEditForm to set
     */
    public void setTraineeEditForm(String traineeEditForm) {
        this.traineeEditForm = traineeEditForm;
    }
}
